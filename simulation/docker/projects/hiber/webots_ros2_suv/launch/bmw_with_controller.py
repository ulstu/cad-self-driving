...
def get_ros2_nodes(*args):
    ...
    urdf = os.path.join(
        package_dir,
        os.path.join(package_dir, pathlib.Path(os.path.join(package_dir, 'resource', 'bmw.urdf'))))
...
def generate_launch_description():
    ...
    robot_description_path = os.path.join(package_dir, pathlib.Path(os.path.join(package_dir, 'resource', 'bmw.urdf')))
