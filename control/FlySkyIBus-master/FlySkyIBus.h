...
private:
  ...
  static const uint8_t PROTOCOL_TIMEGAP = 2; // Packets are received very ~7ms so use ~half that for the gap
  static const uint8_t PROTOCOL_CHANNELS = 10;
  static const uint8_t PROTOCOL_CMD = 0x55; // Command is always 0x40
