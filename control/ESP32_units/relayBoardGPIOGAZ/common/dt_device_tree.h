...
typedef struct _ddt_t
{
    ...
    gpio_num_t gpio_factory_run_led;
    u8_t gpio_phyrst;

    gpio_num_t gpio_595165_pl;
    gpio_num_t gpio_595165_rck;
    gpio_num_t gpio_595165_sdi;
    gpio_num_t gpio_595165_q7;
    gpio_num_t gpio_595165_clk;
...
{ \
    ...
    .gpio_factory_run_led = GPIO_NUM_2,\
    .gpio_phyrst = 0,\
    .gpio_595165_pl     = GPIO_NUM_32,\
    .gpio_595165_rck    = GPIO_NUM_15,\
    .gpio_595165_sdi    = GPIO_NUM_13,\
    .gpio_595165_q7     = GPIO_NUM_16,\
    .gpio_595165_clk    = GPIO_NUM_14,\
    .rtc_scl = GPIO_NULL,\
    .rtc_sda = GPIO_NULL,\
}
